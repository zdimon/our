...
/**
 * Hotlistlog filter form base class.
 *
 * @package    levandos
 * @subpackage filter
 ...
 */
abstract class BaseHotlistlogFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('hotlistlog_filters[%s]');
