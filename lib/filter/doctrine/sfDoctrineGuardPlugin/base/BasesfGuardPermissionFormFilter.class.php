...
abstract class BasesfGuardPermissionFormFilter extends BaseFormFilterDoctrine
{
  ...
  public function addSfForumCategoryListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('sfForumCategoryPermissions.category_id', $values)
    ;
  }
  ...
  public function getFields()
  {
    return array(
      ...
      'groups_list'            => 'ManyKey',
      'users_list'             => 'ManyKey',
      'sf_forum_category_list' => 'ManyKey',
    );
  }
}
