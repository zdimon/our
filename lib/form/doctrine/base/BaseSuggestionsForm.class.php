...
/**
 * Suggestions form base class.
 *
 * @method Suggestions getObject() Returns the current form's model object
 *
 * @package    levandos
 * @subpackage form
 ...
 */
abstract class BaseSuggestionsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('suggestions[%s]');
