...
/**
 * Testimonials form base class.
 *
 * @method Testimonials getObject() Returns the current form's model object
 *
 * @package    levandos
 * @subpackage form
 ...
 */
abstract class BaseTestimonialsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('testimonials[%s]');
