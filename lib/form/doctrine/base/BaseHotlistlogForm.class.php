...
/**
 * Hotlistlog form base class.
 *
 * @method Hotlistlog getObject() Returns the current form's model object
 *
 * @package    levandos
 * @subpackage form
 ...
 */
abstract class BaseHotlistlogForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('hotlistlog[%s]');
