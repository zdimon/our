...
/**
 * MyCountry form base class.
 *
 * @method MyCountry getObject() Returns the current form's model object
 *
 * @package    levandos
 * @subpackage form
 ...
 */
abstract class BaseMyCountryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('my_country[%s]');
