...
/**
 * SeoTranslation form base class.
 *
 * @method SeoTranslation getObject() Returns the current form's model object
 *
 * @package    levandos
 * @subpackage form
 ...
 */
abstract class BaseSeoTranslationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('seo_translation[%s]');
