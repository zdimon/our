...
/**
 * Hotlist form base class.
 *
 * @method Hotlist getObject() Returns the current form's model object
 *
 * @package    levandos
 * @subpackage form
 ...
 */
abstract class BaseHotlistForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'last_message_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('LastMessage'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('hotlist[%s]');
