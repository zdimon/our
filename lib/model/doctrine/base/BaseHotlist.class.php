 ...
 * @method Hotlist     setFromId()          Sets the current record's "from_id" value
 * @method Hotlist     setToId()            Sets the current record's "to_id" value
 * @method Hotlist     setLastMessageId()   Sets the current record's "last_message_id" value
 * @method Hotlist     setIsNewMessage()    Sets the current record's "is_new_message" value
 * @method Hotlist     setIsOpened()        Sets the current record's "is_opened" value
 * @method Hotlist     setIsActive()        Sets the current record's "is_active" value
 * @method Hotlist     setFromUser()        Sets the current record's "FromUser" value
 * @method Hotlist     setToUser()          Sets the current record's "ToUser" value
 * @method Hotlist     setLastMessage()     Sets the current record's "LastMessage" value
 * 
 * @package    levandos
 * @subpackage model
