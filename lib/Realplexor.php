...
class Dklab_Realplexor
{
	 ...
	 */
        ...
        static function sendMessage($options = array())
        {
            $rpl = new Dklab_Realplexor('88.190.203.95', "10010", $options['namespace']);
            $rpl->send(array($options['chanel']), array('url'=>$options['url']));
        }
