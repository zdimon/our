...
class sfPaymentPayPal extends sfPaymentGatewayInterface {
 ...
 protected function getDays($summa,$t)
 {
       $cos = $t->getSumma();
       $dni  = ($summa/$cos)*30;
       return $dni;
       //if($summa==15 or $summa==12 or $summa==5 or $summa==3) return 30;
       //if($summa==25 or $summa==19 or $summa==8 or $summa==6) return 60;
       //if($summa==35 or $summa==26 or $summa==10 or $summa==9) return 90;
       //return 1;
  }
  ...
  protected function makePayment($tp_id,$user_id,$ammount,$summa)
  {
        ...
        $date_expire = $dt->addDay($this->getDays($summa,$t));
