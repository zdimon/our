    ...
    <table class="table3" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody>
        ...
        <tr>
          ...
          <td>
                <p style="color: white; font-size: 12px; font-weight: bold"> <?= __('You are invited to chat on') ?>: </p>
                ...
                <p style="color: white; font-size: 12px; font-weight: bold"> <?= __('Status of the invitation') ?>: <?= $i->getStatusStr() ?> </p>
                 ...
                 <p>
                  <?= link_to(__('Accept'),'appointment/accept?id='.$i->getId(),array('class'=>'but')); ?>
                  <?= link_to(__('Refuse'),'appointment/refuse?id='.$i->getId(),array('class'=>'but')); ?>
              </p>
