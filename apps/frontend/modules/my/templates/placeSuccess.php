...
<?php endif; ?>
        ...
        <tr>
            <th colspan="2" align="center">
                <?php echo pager_navigation($pager, url_for('my/place'),array('alias')) ?>
            </th>
        </tr>
    </table>
    <?php endif ?>
...
<form class="form_style" action="<?= url_for('my/place') ?>" method="POST" enctype="multipart/form-data">
		...
		<?php echo $form->renderGlobalErrors() ?>
            ...
            <div class="row">
                 <?php echo $form[$sf_user->getCulture()]['city']->renderLabel(null, array('class' => 'required star')) ?>
                  <?php echo $form[$sf_user->getCulture()]['city'] ?>
                  <?php echo $form[$sf_user->getCulture()]['city']->renderError() ?>
             </div>
