        ...
        <div class="ui-widget">
            <div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">
                <p><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .7em;"></span>
                    <strong><?= __('Error') ?>:</strong> <?= __('Chek you form please! Some fields are wrong OR not filled. Look our error message and correct the fields before to save.') ?> </p>
...
<?php // echo $form ?>
        ...
        <div id="tabs-1">
            ...
            <div class="row">
                 <?php echo $form['first_name']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
            ...
            <div class="row">
                 <?php echo $form['last_name']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
              ...
              <div class="row">
                 <?php echo $form['real_name']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
            ...
            <div class="row">
                <?php echo $form['city']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
                <?php echo $form['city'] ?>
                <?php echo $form['city']->renderError() ?>
            </div>

              <div class="row">
                <?php echo $form['country']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
            ...
            <div class="row">
                <?php echo $form['height']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
                <?php echo $form['height'] ?>
                <?php echo $form['height']->renderError() ?>
            </div>

            <div class="row">
                <?php echo $form['weight']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
                <?php echo $form['weight'] ?>
                <?php echo $form['weight']->renderError() ?>
            </div>

            <div class="row">
                <?php echo $form['eye_color']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
                <?php echo $form['eye_color'] ?>
                <?php echo $form['eye_color']->renderError() ?>
            </div>

            <div class="row">
                <?php echo $form['hair_color']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
            ...
            <div class="row">
                <?php echo $form['hair_lenght']->renderLabel(null, array('class' => 'required star')) ?><span class="required red">*</span>
