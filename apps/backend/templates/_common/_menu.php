...
<div style="display: inline-block; float: left; width: 200px">
    ...
    <div id="content-engines" style="display: none;">
        <ul>
            ...
            <?php if($sf_user->hasCredential('suggestions')): ?>
            <li><a href="<?=  url_for('suggestions/index') ?>" class="ui-state-default ui-corner-all"><?= __('Suggestions') ?></a></li>
            <?php endif; ?>            
    ...
    <div id="user-engines" style="display: none;">
        <ul>
            ...
            <?php endif; ?>
             ...
             <?php if($sf_user->hasCredential('falses')): ?>
            <li><a  href="<?=  url_for('false/manage') ?>" class="ui-state-default ui-corner-all"><?= __('False profile') ?></a></li>
            <?php endif; ?>           
    ...
    <div id="setting-staff" style="display: none;">
        <ul>
            ...
            <li><a  href="<?=  url_for('type_actions/index') ?>" class="ui-state-default ui-corner-all"><?= __('Type actions') ?></a></li>
            <li><a  href="<?=  url_for('actions/index') ?>" class="ui-state-default ui-corner-all"><?= __('Actions') ?></a></li>
        </ul>
    </div>
    <?php endif; ?>
